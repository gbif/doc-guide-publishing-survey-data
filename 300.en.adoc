...
* Higher (parent) Event levels should include information that applies to all subsequent and lower Events. +
* Lower (child) Event level represents an Event that implements a single, reported sampling protocol at a single site  at a particular interval of time.
...
* relationships among datasets need to be preserved or exposed (e.g., datasets resulting from different types of surveys within the same Project and/or at the same established survey sites  ........ ###### REFER reader to future sections for more information ########).
