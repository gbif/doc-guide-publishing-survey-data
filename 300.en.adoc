...
[[fig4]]
[caption="Figure 4. "]
.Three potential data structures for a zooplankton survey conducted at 20 stations, each sampled once during the day and once at night: non-nested structure (a), simple nested structure (b), and complex or deeply  nested structure (c).
image::img/Fig4.png[]
